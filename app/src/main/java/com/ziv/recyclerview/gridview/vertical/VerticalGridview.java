...
/**
 * 使用RecyclerView实现Gridview
 * Created by ziv on 16-11-29.
 */

public class VerticalGridview  extends AppCompatActivity {
    private static final int SPAN_COUNT = 4;

    private RecyclerView mRecyclerView;
    private VerticalGridAdapter mAdapter;
    ...
    private void initView() {
        ...
        // 设置DividerItemDecoration.HORIZONTAL会将全屏幕绘制，当数据小于一屏幕时，需要做限制
        // 以下两个有先后顺序区别，谁后绘制，谁显示在上面
        mRecyclerView.addItemDecoration(new DividerGridItemDecoration(this, DividerItemDecoration.HORIZONTAL));
        mRecyclerView.addItemDecoration(new DividerGridItemDecoration(this, DividerItemDecoration.VERTICAL));
    }
    ...
    private void initData() {
        ...
        mAdapter = new VerticalGridAdapter(getApplicationContext(), mDatas);
    }
}